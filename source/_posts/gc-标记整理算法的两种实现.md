...
## 导语
传统gc算法有：标记清除，引用计数，复制算法，标记整理。它们各有优点，标记整理的优点就是空间整理功能。
...
![标记整理-初始状态](gc/标记整理-初始状态.png)

标记结束后：
![标记整理-标记后](gc/标记整理-标记后.png)

在垃圾回收后：
![标记整理-整理后](gc/标记整理-整理后.png)
...
![lisp2设置forwarding指针](gc/lisp2设置forwarding指针.png)
